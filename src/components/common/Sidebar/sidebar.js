                            ...
                            data?.map((item, index) => {
                                return (
                                    <Fragment key={index}>
                                        ...
                                        <li id={index} onClick={(e) => {setSelectItem(index); handleExam(item); e.stopPropagation();}} style={selectItem === index ? { backgroundColor: "#722E60" , cursor: "pointer", color: "#fff" } : {}} key={index}>{item}</li>
                                    </Fragment>
                                )
                            })
                        }
